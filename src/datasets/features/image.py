...
class Image:
    ...
    def cast_storage(self, storage: Union[pa.StringArray, pa.StructArray, pa.ListArray]) -> pa.StructArray:
        ...
        if pa.types.is_string(storage.type):
            ...
            try:
                ...
                raise OverflowError(
                    f"[Image] failed to downcast large_binary -> binary; data exceeds the 2 GiB pa.binary() limit. "
                    f"Use paths instead of embedding bytes for large media. Original error: {e}"
                ) from e
    ...
    def embed_storage(self, storage: pa.StructArray, token_per_repo_id=None) -> pa.StructArray:
        ...
        check_pa_binary_fits(_bytes_list, feature_name="Image")
